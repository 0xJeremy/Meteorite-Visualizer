    ...
    <div>
      ...
      >
        <DialogTitle className={classes.box}>
          Meteorite Data Visualizer
        </DialogTitle>
        <DialogContent className={classes.box}>
          <DialogContentText className={classes.box}>
            Welcome to the meteorite data visualizer. This page shows all the
            meteorite data ever collected by NASA. You can view the original
            dataset{" "}
            <a
            ...
            <a
              className={classes.link}
              href="https://github.com/0xJeremy/Meteorite-Visualizer/"
              target="_blank"
              rel="noopener noreferrer"
            >
              here
            ...
            <a
              className={classes.link}
              href="https://github.com/0bLondon/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Ben London
